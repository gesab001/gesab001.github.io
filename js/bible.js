...
// document.getElementById("topics").innerHTML = "hello";
    ...
    xhttp.open("GET", "https://bible.onecloudapps.net/topics.json", true);
    xhttp.send();
...
xhttp.open("GET", "https://bible.onecloudapps.net/bible.xml", true);
xhttp.send();
...
function getMinuteVerse() {
    ...
    if (xmlDoc.evaluate) {
        ...
        txt += title+bookName + " "+ chapterNumber+":"+verseNumber+" " +word + "<br>";
